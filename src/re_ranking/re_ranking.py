...
def run():
    ...
    parser.add_argument('data_cache_targets', type=str, help='Name under which the cached targets should be stored.')
    ...
    Path(caching_directory).mkdir(parents=True, exist_ok=True)
    caching_directory_targets = os.path.join(DATA_PATH, "cache", args.data_cache_targets)
