    ...
    for idx, data_name in enumerate(data_names):
        ...
        for similarity_feature in features:
            ...
            if len(similarity_feature) == 2:
                ...
                map_5 = float(get_map_5(repo_path + "/data/" + data_name))

                table_dict[column].append(map_5)
                all_dataset_scores[encoder].append(map_5)
                ...
                map_5 = float(get_map_5(
                    repo_path + "/data/" + data_name))
